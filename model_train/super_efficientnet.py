...
def super_efficientnet_main(epoch=300,lr=0.0002):
    #device : GPU or CPU
    device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
    print(device)
    ...
    save_path = '.params/Super_EfficientNet.pth'
    best_acc = 0.0
...
if __name__ == '__main__':
    ...
    try:
        ...
        lr = 0.0002
    # strat training
    net, train_loss_list, train_acc_list, test_loss_list, test_acc_list, test_loader = super_efficientnet_main(epoch=epoch,lr=lr)
